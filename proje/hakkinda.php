...
<body style="margin-right:50px; margin-left:50px;">
    ...
    <section class="container" style="margin-top:30px">
        <section class="row">
            ...
            <article class="col-8">
                <h1> Özgür ben </h1>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;Özgür ben aaaaaaaaa aaaaaaaaaaa aaaaaaaaa aaaaaaaaaa aaaaaaaaaaa aaaaaa aaaaaaaaaaaa aaaaaaaaaaa aaaaaaaaaaaa aaaaaaaaaaaaaaaaa aaaaaaaaaaaaaa aaaaaaaaaaaaaaa aaaaaaaa</p>
            </article>
        </section>
        <br><br>
        <article class="row">
